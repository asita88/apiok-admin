...
func AccessLogList(request *validators.AccessLogList) ([]map[string]interface{}, int, error) {
	list, total, err := models.AccessLogListPage(request)
	if err != nil {
		return nil, 0, err
	}
	if list == nil {
