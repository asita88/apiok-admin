...
const (
	...
	PluginIdLogKafka       = "pl-LogKafkaZxaqOgRZ"
	PluginIdLogMysql       = "pl-LogMysqlZxaqOgRZ"
	PluginIdTrafficTag     = "pl-TrafficTagZxaqOgR"
	PluginIdRequestRewrite  = "pl-RequestRewriteZxaqO"
	PluginIdResponseRewrite = "pl-ResponseRewriteZxaq"
	...
	PluginKeyWaf            = "waf"
	PluginKeyLogKafka       = "log-kafka"
	PluginKeyLogMysql       = "log-mysql"
	PluginKeyTrafficTag     = "traffic-tag"
	PluginKeyRequestRewrite  = "request-rewrite"
	PluginKeyResponseRewrite = "response-rewrite"
	...
	PluginIconLogKafka       = "icon-log-kafka"
	PluginIconLogMysql       = "icon-log-mysql"
	PluginIconTrafficTag     = "icon-traffic-tag"
	PluginIconRequestRewrite  = "icon-request-rewrite"
	PluginIconResponseRewrite = "icon-response-rewrite"
	...
	PluginDescLogKafka       = "将访问日志发送到Kafka消息队列"
	PluginDescLogMysql       = "将访问日志存储到MySQL数据库"
	PluginDescTrafficTag     = "根据匹配规则为请求添加流量标签"
	PluginDescRequestRewrite  = "重写请求URI、请求头和查询参数"
	PluginDescResponseRewrite = "重写响应头、状态码和响应体"
